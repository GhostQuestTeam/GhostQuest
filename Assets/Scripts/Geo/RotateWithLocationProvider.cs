...
namespace HauntedCity.Geo
{
    public class RotateWithLocationProvider : MonoBehaviour
    {
        ...
        /// </summary>
        [SerializeField] float _rotationFollowFactor;
        ...
        void LocationProvider_OnHeadingUpdated(object sender, HeadingUpdatedEventArgs e)
        {
            ...
            transform.localRotation = Quaternion.Lerp(transform.localRotation, rotation,
                Time.deltaTime * _rotationFollowFactor);
        }
    }
}